...
const TournamentPage = () => {
  return (
    <div
      className="pl-0 lg:pl-[210px] xl:pl-62
    ...
    >
      <div>
        <div className="w-full px-0 py-0 lg:px-16 lg:py-8">
          ...
          <div className="fixed z-61 cursor-pointer bottom-0 left-0 mt-2.5 right-0  ml-0 lg:ml-[210px] xl:ml-62 bg-[#001208] shadow-[0px_-2px_4px_0px_#FFFFFF40] flex justify-end  p-4 md:py-5 md:px-16">
