    ...
    >
      <div>
        <div className="w-full px-0 py-0 lg:px-16 lg:py-8">
          ...
          <div className="fixed cursor-pointer bottom-0 left-0 mt-2.5 right-0 z-35 ml-0 lg:ml-[210px] xl:ml-[248px] bg-[#001208] shadow-[0px_-2px_4px_0px_#FFFFFF40] flex justify-end  p-4 md:py-5 md:px-16">
